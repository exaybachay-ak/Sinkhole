<#    
      ...
      #Powershell blackhole script
          ...
          In order to verify this, try run a to traceroute to 218.207.103.155
          ...
          If you want to un-do the changes, select the reverse changes option and it will roll things back. 
